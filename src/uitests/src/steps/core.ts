...
Given('VS Code is closed', function () { return this.app.exit(); });

When('I close VS Code', function () { return this.app.exit(); });

When('I start VS Code', function () { return this.app.start(); });

When('I reload VS Code', function () { return this.app.reload(); });
