...
suite("Activation - Downloader", () => {
    ...
    test("Get download info - HTTPS without resource", async () => {
        ...
        workspaceService
            .setup(w =>
                w.getConfiguration(TypeMoq.It.isValue("http"), undefined)
            )
            .returns(() => cfg.object)
            .verifiable(TypeMoq.Times.once());
    ...
    suite("Test LanguageServerDownloader.downloadLanguageServer", () => {
        ...
        setup(() => {
            ...
            platformData = TypeMoq.Mock.ofType<IPlatformData>(
                undefined,
                TypeMoq.MockBehavior.Strict
            );
        ...
        test("Display error message if LS downloading fails", async () => {
            ...
            folderService
                ...
                .returns(() => Promise.resolve(pkg));
            output.setup(o =>
                o.appendLine(LanguageService.downloadFailedOutputMessage())
            );
        ...
        test("Display error message if LS extraction fails", async () => {
            ...
            folderService
                ...
                .returns(() => Promise.resolve(pkg));
            output.setup(o =>
                o.appendLine(LanguageService.extractionFailedOutputMessage())
            );
            output.setup(o => o.appendLine((failure as unknown) as string));
            appShell
                .setup(a =>
