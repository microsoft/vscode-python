...
export class UnitTestIocContainer extends IocContainer {
    ...
    public registerTestVisitors() {
        ...
        this.serviceManager.addSingleton<ITestContextService>(
            ITestContextService,
            TestContextService
        );
    }
    ...
    public registerTestDiscoveryServices() {
        ...
        this.serviceManager.add<ITestDiscoveredTestParser>(
    ...
    public registerTestDiagnosticServices() {
        this.serviceManager.addSingleton<ITestDiagnosticService>(
