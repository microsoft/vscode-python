...
export class MockLanguageClient extends LanguageClient {
        ...
        switch (method.method) {
            ...
            default:
                if (this.notificationPromise) {
                    this.notificationPromise.reject(
                        new Error(`Unknown notification ${method.method}`)
                    );
                }
                break;
        }
    ...
    public registerFeatures(
        _features: (StaticFeature | DynamicFeature<any>)[]
    ): void {
        throw new Error("Method not implemented.");
    }
    public registerFeature(
        _feature: StaticFeature | DynamicFeature<any>
    ): void {
        throw new Error("Method not implemented.");
    }
