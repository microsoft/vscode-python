...
export class MockProtocolConverter implements Code2ProtocolConverter {
    ...
    public asTextDocumentIdentifier(
        _textDocument: code.TextDocument
    ): proto.TextDocumentIdentifier {
        throw new Error("Method not implemented.");
    }
    public asOpenTextDocumentParams(
        _textDocument: code.TextDocument
    ): proto.DidOpenTextDocumentParams {
        throw new Error("Method not implemented.");
    }
    public asChangeTextDocumentParams(
    ...
    public asCloseTextDocumentParams(
        _textDocument: code.TextDocument
    ...
    public asWillSaveTextDocumentParams(
        _event: code.TextDocumentWillSaveEvent
    ...
    public asPosition(
        value: code.Position | null | undefined
    ): proto.Position | null | undefined;
    ...
    public asRange(
        value: code.Range | null | undefined
    ): proto.Range | null | undefined;
    ...
    public asFormattingOptions(
        _item: code.FormattingOptions
    ): proto.FormattingOptions {
        throw new Error("Method not implemented.");
    }
    public asDocumentSymbolParams(
        _textDocument: code.TextDocument
    ): proto.DocumentSymbolParams {
        throw new Error("Method not implemented.");
    }
    public asCodeLensParams(
        _textDocument: code.TextDocument
