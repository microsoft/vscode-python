...
for _ in range(50):
    ...
    sys.stdout.write('\\r')`;
            ...
            await addCode(
                ...
                wrapper,
                spinningCursor,
                4 + (ioc.mockJupyter ? cursors.length * 3 : 0)
            );
    ...
    runMountedTest(
        ...
        async wrapper => {
            ...
            const cellButtons = afterUndo
                .at(afterUndo.length - 2)
                .find(CellButton);
