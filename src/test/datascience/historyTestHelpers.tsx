...
export function verifyHtmlOnCell(
    ...
    if (html) {
        ...
        assert.ok(
            targetCell!.isEmptyRender(),
            "Target cell is not empty render"
        );
    }
}
...
export async function addCode(
    historyProvider: () => Promise<IHistory>,
    wrapper: ReactWrapper<any, Readonly<{}>, React.Component>,
    code: string,
...
function simulateKey(
    ...
    if (result) {
        event = createKeyboardEvent("keypress", {
            key,
            code: key,
            shiftKey: shiftDown
        });
        ...
        if (result) {
            event = createKeyboardEvent("keyup", {
                key,
                code: key,
                shiftKey: shiftDown
            });
...
function enterKey(
    _wrapper: ReactWrapper<any, Readonly<{}>, React.Component>,
    textArea: HTMLTextAreaElement,
    key: string
) {
...
export function typeCode(
    ...
    const textArea = ecDom!
        .querySelector(".overflow-guard")!
...
export function updateDataScienceSettings(
    wrapper: ReactWrapper<any, Readonly<{}>>,
...
export function toggleCellExpansion(
    wrapper: ReactWrapper<any, Readonly<{}>, React.Component>
) {
