...
import { ASYNC_DEF_REGEX, ASYNC_FOR_IN_REGEX, CLASS_REGEX, DEF_REGEX, ELIF_REGEX, ELSE_REGEX, EXCEPT_REGEX, FINALLY_REGEX, FOR_IN_REGEX, IF_REGEX, TRY_REGEX, WHILE_REGEX } from './contracts';
