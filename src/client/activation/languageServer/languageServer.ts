...
export class LanguageServer implements ILanguageServer {
    ...
    constructor(
        ...
        private readonly testManager: ITestManagementService,
    ...
    public async start(
        ...
        if (!this.languageClient) {
            ...
            const progressReporting = new ProgressReporting(
                this.languageClient!
            );
            ...
            if (settings.downloadLanguageServer) {
                this.languageClient.onTelemetry(telemetryEvent => {
                    const eventName =
                        ...
                        EventName.PYTHON_LANGUAGE_SERVER_TELEMETRY;
                    sendTelemetryEvent(
                        eventName,
    ...
    protected async registerTestServices() {
        ...
        await this.testManager.activate(
            new LanguageServerSymbolProvider(this.languageClient!)
        );
    }
}
