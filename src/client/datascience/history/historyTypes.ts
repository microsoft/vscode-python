...
export namespace HistoryMessages {
    ...
    export const ProvideCompletionItemsRequest =
        "provide_completion_items_request";
    export const CancelCompletionItemsRequest =
        "cancel_completion_items_request";
    export const ProvideCompletionItemsResponse =
        "provide_completion_items_response";
    ...
    export const ProvideSignatureHelpResponse =
        "provide_signature_help_response";
