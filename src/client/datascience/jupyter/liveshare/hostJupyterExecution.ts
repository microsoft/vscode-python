...
export class HostJupyterExecution
    ...
    public async onAttach(api: vsls.LiveShare | null): Promise<void> {
        ...
        if (api) {
            ...
            if (service) {
                service.onRequest(
                    LiveShareCommands.isNotebookSupported,
                    this.onRemoteIsNotebookSupported
                );
                service.onRequest(
                    LiveShareCommands.isImportSupported,
                    this.onRemoteIsImportSupported
                );
                service.onRequest(
                    LiveShareCommands.isKernelCreateSupported,
                    this.onRemoteIsKernelCreateSupported
                );
                service.onRequest(
                    LiveShareCommands.isKernelSpecSupported,
                    this.onRemoteIsKernelSpecSupported
                );
                service.onRequest(
                    LiveShareCommands.connectToNotebookServer,
                    this.onRemoteConnectToNotebookServer
                );
                service.onRequest(
                    LiveShareCommands.getUsableJupyterPython,
                    this.onRemoteGetUsableJupyterPython
                );
            }
        }
    }
    ...
    private onRemoteIsNotebookSupported = (
        _args: any[],
    ...
    private onRemoteIsImportSupported = (
        _args: any[],
        cancellation: CancellationToken
    ): Promise<any> => {
        // Just call local
    ...
    private onRemoteIsKernelCreateSupported = (
        _args: any[],
        cancellation: CancellationToken
    ): Promise<any> => {
        // Just call local
    ...
    private onRemoteIsKernelSpecSupported = (
        _args: any[],
        cancellation: CancellationToken
    ): Promise<any> => {
        // Just call local
    ...
    private onRemoteGetUsableJupyterPython = (
        _args: any[],
        cancellation: CancellationToken
    ): Promise<any> => {
        // Just call local
