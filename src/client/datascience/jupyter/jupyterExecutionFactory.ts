...
interface IJupyterExecutionInterface
    extends IRoleBasedObject,
        IJupyterExecution {}
...
@injectable()
export class JupyterExecutionFactory
    implements IJupyterExecution, IAsyncDisposable {
    private executionFactory: RoleBasedFactory<
        IJupyterExecutionInterface,
        JupyterExecutionClassType
    >;
    private sessionChangedEventEmitter: EventEmitter<void> = new EventEmitter<
        void
    >();
