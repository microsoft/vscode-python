...
export class NotebookProvider implements INotebookProvider {
    ...
    private _potentialKernelChanged = new EventEmitter<{ identity: Uri; kernel: KernelSelection }>();
    ...
    public firePotentialKernelChanged(identity: Uri, kernel: KernelSelection) {
