...
const messageWithMessageTypes: MessageMapping<IInteractiveWindowMapping> = {
    ...
    [InteractiveWindowMessages.NotebookClean]: MessageType.syncAcrossSameNotebooks | MessageType.syncWithLiveShare,
    [InteractiveWindowMessages.NotebookDirty]: MessageType.syncAcrossSameNotebooks | MessageType.syncWithLiveShare,
