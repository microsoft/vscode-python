...
const messageWithMessageTypes: MessageMapping<IInteractiveWindowMapping> & MessageMapping<CommonActionTypeMapping> = {
    ...
    [CommonActionType.EXECUTE_CELL_DEPS]: MessageType.other,
    ...
    [CommonActionType.COMPUTE_STALE_CELLS]: MessageType.other,
    ...
    [InteractiveWindowMessages.Stale]: MessageType.other,
    [InteractiveWindowMessages.ComputeStaleCells]: MessageType.other,
    [InteractiveWindowMessages.RunDependents]: MessageType.other,
