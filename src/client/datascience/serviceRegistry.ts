...
import { KernelProcess } from './kernel-launcher/kernelProcess';
import { IKernelFinder, IKernelLauncher, IKernelProcess } from './kernel-launcher/types';
...
export function registerTypes(serviceManager: IServiceManager) {
    ...
    serviceManager.add<IKernelProcess>(IKernelProcess, KernelProcess);
    serviceManager.add<IKernelFinder>(IKernelFinder, KernelFinder);
