...
export class DataScience implements IDataScience {
    ...
    private async selectJupyterLaunchURI(): Promise<void> {
        ...
        const userURI = await this.appShell.showInputBox({prompt: localize.DataScience.jupyterSelectURIPrompt(), placeHolder: 'https://hostname:8080/?token=849d61a414abafab97bc4aab1f3547755ddc232c2b8cb7fe',
         validateInput: this.validateURI, ignoreFocusOut: true});
