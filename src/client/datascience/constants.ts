...
export enum Telemetry {
    ...
    SelectJupyterURI = 'PERFORMANCE.SELECT_JUPYTER_URI',
    SetJupyterURIToLocal = 'PERFORMANCE.SET_JUPYTER_URI_LOCAL',
    SetJupyterURIToUserSpecified = 'DATASCIENCE.SET_JUPYTER_URI_USER_SPECIFIED',
    Interrupt = 'PERFORMANCE.INTERRUPT',
    ExportPythonFile = 'DATASCIENCE.EXPORT_PYTHON_FILE',
    ExportPythonFileAndOutput = 'DATASCIENCE.EXPORT_PYTHON_FILE_AND_OUTPUT',
    StartJupyter = 'PERFORMANCE.JUPYTERSTARTUPCOST',
    SubmitCellThroughInput = 'DATASCIENCE.SUBMITCELLFROMREPL',
    ConnectLocalJupyter = 'PERFORMANCE.CONNECTLOCALJUPYTER',
    ConnectRemoteJupyter = 'PERFORMANCE.CONNECTREMOTEJUPYTER',
    ConnectFailedJupyter = 'PERFORMANCE.CONNECTFAILEDJUPYTER',
    ConnectRemoteFailedJupyter = 'PERFORMANCE.CONNECTREMOTEFAILEDJUPYTER',
    ConnectRemoteSelfCertFailedJupyter = 'PERFORMANCE.CONNECTREMOTESELFCERTFAILEDJUPYTER',
    SelfCertsMessageEnabled = 'PERFORMANCE.SELFCERTSMESSAGEENABLED',
    SelfCertsMessageClose = 'PERFORMANCE.SELFCERTSMESSAGECLOSE',
    RemoteAddCode = 'DATASCIENCE.LIVESHARE.ADDCODE',
    ShiftEnterBannerShown = 'DATASCIENCE.SHIFTENTER_BANNER_SHOWN',
    EnableInteractiveShiftEnter = 'PERFORMANCE.ENABLE_INTERACTIVE_SHIFT_ENTER',
    DisableInteractiveShiftEnter = 'PERFORMANCE.DISABLE_INTERACTIVE_SHIFT_ENTER',
    ShowDataViewer = 'DATASCIENCE.SHOW_DATA_EXPLORER',
    RunFileInteractive = 'DATASCIENCE.RUN_FILE_INTERACTIVE',
    DebugFileInteractive = 'DEBUGGING.DEBUG_FILE_INTERACTIVE',
    PandasNotInstalled = 'PERFORMANCE.SHOW_DATA_NO_PANDAS',
    PandasTooOld = 'PERFORMANCE.SHOW_DATA_PANDAS_TOO_OLD',
    DataScienceSettings = 'PERFORMANCE.SETTINGS',
    ...
    DebugCurrentCell = 'DEBUGGING.DEBUG_CURRENT_CELL',
    CodeLensAverageAcquisitionTime = 'PERFORMANCE.CODE_LENS_ACQ_TIME',
    ClassConstructionTime = 'PERFORMANCE.CLASS_CONSTRUCTION_TIME',
    FindJupyterCommand = 'PERFORMANCE.FIND_JUPYTER_COMMAND',
    StartJupyterProcess = 'PERFORMANCE.START_JUPYTER_PROCESS',
    WaitForIdleJupyter = 'PERFORMANCE.WAIT_FOR_IDLE_JUPYTER',
    HiddenCellTime = 'PERFORMANCE.HIDDEN_EXECUTION_TIME',
    RestartJupyterTime = 'PERFORMANCE.RESTART_JUPYTER_TIME',
    InterruptJupyterTime = 'PERFORMANCE.INTERRUPT_JUPYTER_TIME',
    ExecuteCell = 'PERFORMANCE.EXECUTE_CELL_TIME',
    ExecuteCellPerceivedCold = 'PERFORMANCE.EXECUTE_CELL_PERCEIVED_COLD',
    ExecuteCellPerceivedWarm = 'PERFORMANCE.EXECUTE_CELL_PERCEIVED_WARM',
    WebviewStartup = 'PERFORMANCE.WEBVIEW_STARTUP',
    VariableExplorerFetchTime = 'PERFORMANCE.VARIABLE_EXPLORER_FETCH_TIME',
    WebviewStyleUpdate = 'PERFORMANCE.WEBVIEW_STYLE_UPDATE',
    WebviewMonacoStyleUpdate = 'PERFORMANCE.WEBVIEW_MONACO_STYLE_UPDATE',
    DataViewerFetchTime = 'PERFORMANCE.DATAVIEWER_FETCH_TIME',
    FindJupyterKernelSpec = 'PERFORMANCE.FIND_JUPYTER_KERNEL_SPEC',
    PtvsdPromptToInstall = 'DEBUGGING.PTVSD_PROMPT_TO_INSTALL',
    PtvsdSuccessfullyInstalled = 'DEBUGGING.PTVSD_SUCCESSFULLY_INSTALLED',
    PtvsdInstallFailed = 'DEBUGGING.PTVSD_INSTALL_FAILED',
    ScrolledToCell = 'PERFORMANCE.SCROLLED_TO_CELL',
    DebugStepOver = 'DEBUGGING.DEBUG_STEP_OVER',
    DebugContinue = 'DEBUGGING.DEBUG_CONTINUE',
    DebugStop = 'DEBUGGING.DEBUG_STOP'
}
