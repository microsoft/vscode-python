...
export enum Telemetry {
    ...
    StaleCellsException = 'DS_INTERNAL.STALE_CELLS_EXCEPTION',
    StaleCellsCompleted = 'DS_INTERNAL.STALE_CELLS_COMPLETED',
...
export enum NativeKeyboardCommandTelemetry {
    ...
    RunDeps = 'DATASCIENCE.NATIVE.KEYBOARD.RUN_DEPS',
...
export enum NativeMouseCommandTelemetry {
    ...
    RunDeps = 'DATASCIENCE.NATIVE.MOUSE.RUN_DEPS',
