...
export enum Telemetry {
    ...
    SelectJupyterURI = 'PERFORMACE.SELECT_JUPYTER_URI',
    SetJupyterURIToLocal = 'PERFORMACE.SET_JUPYTER_URI_LOCAL',
    SetJupyterURIToUserSpecified = 'DATASCIENCE.SET_JUPYTER_URI_USER_SPECIFIED',
    Interrupt = 'PERFORMACE.INTERRUPT',
    ExportPythonFile = 'DATASCIENCE.EXPORT_PYTHON_FILE',
    ExportPythonFileAndOutput = 'DATASCIENCE.EXPORT_PYTHON_FILE_AND_OUTPUT',
    StartJupyter = 'PERFORMACE.JUPYTERSTARTUPCOST',
    SubmitCellThroughInput = 'DATASCIENCE.SUBMITCELLFROMREPL',
    ConnectLocalJupyter = 'PERFORMACE.CONNECTLOCALJUPYTER',
    ConnectRemoteJupyter = 'PERFORMACE.CONNECTREMOTEJUPYTER',
    ConnectFailedJupyter = 'PERFORMACE.CONNECTFAILEDJUPYTER',
    ConnectRemoteFailedJupyter = 'PERFORMACE.CONNECTREMOTEFAILEDJUPYTER',
    ConnectRemoteSelfCertFailedJupyter = 'PERFORMACE.CONNECTREMOTESELFCERTFAILEDJUPYTER',
    SelfCertsMessageEnabled = 'PERFORMACE.SELFCERTSMESSAGEENABLED',
    SelfCertsMessageClose = 'PERFORMACE.SELFCERTSMESSAGECLOSE',
    RemoteAddCode = 'DATASCIENCE.LIVESHARE.ADDCODE',
    ShiftEnterBannerShown = 'DATASCIENCE.SHIFTENTER_BANNER_SHOWN',
    EnableInteractiveShiftEnter = 'PERFORMACE.ENABLE_INTERACTIVE_SHIFT_ENTER',
    DisableInteractiveShiftEnter = 'PERFORMACE.DISABLE_INTERACTIVE_SHIFT_ENTER',
    ...
    PandasNotInstalled = 'PERFORMACE.SHOW_DATA_NO_PANDAS',
    PandasTooOld = 'PERFORMACE.SHOW_DATA_PANDAS_TOO_OLD',
    DataScienceSettings = 'PERFORMACE.SETTINGS',
    ...
    CodeLensAverageAcquisitionTime = 'PERFORMACE.CODE_LENS_ACQ_TIME',
    ClassConstructionTime = 'PERFORMACE.CLASS_CONSTRUCTION_TIME',
    FindJupyterCommand = 'PERFORMACE.FIND_JUPYTER_COMMAND',
    StartJupyterProcess = 'PERFORMACE.START_JUPYTER_PROCESS',
    WaitForIdleJupyter = 'PERFORMACE.WAIT_FOR_IDLE_JUPYTER',
    HiddenCellTime = 'PERFORMACE.HIDDEN_EXECUTION_TIME',
    RestartJupyterTime = 'PERFORMACE.RESTART_JUPYTER_TIME',
    InterruptJupyterTime = 'PERFORMACE.INTERRUPT_JUPYTER_TIME',
    ExecuteCell = 'PERFORMACE.EXECUTE_CELL_TIME',
    ExecuteCellPerceivedCold = 'PERFORMACE.EXECUTE_CELL_PERCEIVED_COLD',
    ExecuteCellPerceivedWarm = 'PERFORMACE.EXECUTE_CELL_PERCEIVED_WARM',
    WebviewStartup = 'PERFORMACE.WEBVIEW_STARTUP',
    VariableExplorerFetchTime = 'PERFORMACE.VARIABLE_EXPLORER_FETCH_TIME',
    WebviewStyleUpdate = 'PERFORMACE.WEBVIEW_STYLE_UPDATE',
    WebviewMonacoStyleUpdate = 'PERFORMACE.WEBVIEW_MONACO_STYLE_UPDATE',
    DataViewerFetchTime = 'PERFORMACE.DATAVIEWER_FETCH_TIME',
    FindJupyterKernelSpec = 'PERFORMACE.FIND_JUPYTER_KERNEL_SPEC',
    ...
    ScrolledToCell = 'PERFORMACE.SCROLLED_TO_CELL',
