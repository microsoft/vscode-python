...
export function getGatherModelForActiveNotebook(notebooks: INotebookTracker, gatherModelRegistry: IGatherModelRegistry): IGatherModel | null {
...
export class GatherModelRegistry implements IGatherModelRegistry {
    ...
    /**
     * Returns null if notebook ID is in an unexpected format.
     */
     ...
     */
    public addGatherModel(notebookModel: INotebookModel, gatherModel: IGatherModel): boolean {
