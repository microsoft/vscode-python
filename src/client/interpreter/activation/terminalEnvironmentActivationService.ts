...
export class TerminalEnvironmentActivationService implements IEnvironmentActivationService {
    constructor(@inject(ITerminalServiceFactory) private readonly terminalFactory: ITerminalServiceFactory, @inject(IFileSystem) private readonly fs: IFileSystem) {}
