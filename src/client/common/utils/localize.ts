...
export namespace DataScience {
    ...
    export const jupyterDebuggerInstallPtvsdNew = localize('Pip module ptvsd is require for debugging cells. Install ptvsd and continue to debug cell?');
    export const jupyterDebuggerInstallPtvsdUpdate = localize('The version of ptvsd installs does not support debugging cells. Update ptvsd to newest version and continue to debug cell?');
    export const jupyterDebuggerInstallPtvsdYes = localize('Yes');
    export const jupyterDebuggerInstallPtvsdNo = localize('No');
}
