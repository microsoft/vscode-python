...
export namespace Diagnostics {
    ...
    export const yesUpdateLaunch = localize(
        "diagnostics.yesUpdateLaunch",
        "Yes, update launch.json"
    );
    ...
    export const updateSettings = localize(
...
export namespace Common {
    ...
    export const noIWillDoItLater = localize(
        "Common.noIWillDoItLater",
        "No, I will do it later"
    );
    export const notNow = localize("Common.notNow", "Not now");
    export const doNotShowAgain = localize(
...
export namespace LanguageService {
    ...
    export const extractionDoneOutputMessage = localize(
        "LanguageService.extractionDoneOutputMessage",
        "done."
    );
...
export namespace DataScience {
    ...
    export const dataExplorerTitle = localize(
    ...
    export const pythonNewHeader = localize(
        "DataScience.pythonNewHeader",
        "Started new kernel:"
    );
    ...
    export const executingCodeFailure = localize(
        "DataScience.executingCodeFailure",
        "Executing code failed : {0}"
    );
    export const inputWatermark = localize(
        "DataScience.inputWatermark",
        "Shift-enter to run"
    );
    ...
    export const liveShareHostFormat = localize(
        "DataScience.liveShareHostFormat",
        "{0} Jupyter Server"
    );
    ...
    export const loadingMessage = localize(
        "DataScience.loadingMessage",
        "loading ..."
    );
    export const fetchingDataViewer = localize(
        "DataScience.fetchingDataViewer",
        "Fetching data ..."
    );
    export const noRowsInDataViewer = localize(
        "DataScience.noRowsInDataViewer",
...
export namespace Testing {
    export const testErrorDiagnosticMessage = localize(
        "Testing.testErrorDiagnosticMessage",
        "Error"
    );
    export const testFailDiagnosticMessage = localize(
        "Testing.testFailDiagnosticMessage",
        "Fail"
    );
    export const testSkippedDiagnosticMessage = localize(
        "Testing.testSkippedDiagnosticMessage",
        "Skipped"
    );
    export const configureTests = localize(
        "Testing.configureTests",
        "Configure Test Framework"
    );
    export const disableTests = localize(
