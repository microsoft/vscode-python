...
export namespace DataScience {
    ...
    export const environmentVariablePtvsdLogDirIsSet = localize('DataScience.environmentVariablePtvsdLogDirIsSet', 'The environment variable "PTVSD_LOG_DIR" should be a directory.');
