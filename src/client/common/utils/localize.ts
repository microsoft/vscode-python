...
export namespace ExtensionChannels {
    ...
    export const reloadToUseInsidersMessage = localize('ExtensionChannels.reloadToUseInsidersMessage', 'Please reload to use the insiders build of the extension');
    export const reloadToChangeChannelMessage = localize('ExtensionChannels.reloadToChangeChannelMessage', 'Please reload the window to change the insiders channel');
