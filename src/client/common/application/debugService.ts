...
export class DebugService implements IDebugService {
    ...
    public startDebugging(folder: WorkspaceFolder | undefined, nameOrConfiguration: string | DebugConfiguration, parentSession?: DebugSession | undefined): Thenable<boolean> {
