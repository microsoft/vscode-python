...
export class BufferLine implements IBufferLine {
    ...
    public get(index: number): CharData {
        ...
        return [
            ...
            content & Content.IS_COMBINED_MASK ? this._combined[index] : cp ? stringFromCodePoint(cp) : '',
    ...
    public set(index: number, value: CharData): void {
        ...
        if (value[CHAR_DATA_CHAR_INDEX].length > 1) {
            ...
            this._data[index * CELL_SIZE + Cell.CONTENT] =
                value[CHAR_DATA_CHAR_INDEX].charCodeAt(0) | (value[CHAR_DATA_WIDTH_INDEX] << Content.WIDTH_SHIFT);
        }
    }
    ...
    public insertCells(pos: number, n: number, fillCellData: ICellData, eraseAttr?: IAttributeData): void {
        ...
        if (pos && this.getWidth(pos - 1) === 2) {
            this.setCellFromCodePoint(
                ...
                eraseAttr?.fg || 0,
                eraseAttr?.bg || 0,
                eraseAttr?.extended || new ExtendedAttrs(),
            );
        }
