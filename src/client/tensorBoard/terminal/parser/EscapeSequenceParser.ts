...
export const VT500_TRANSITION_TABLE = (function (): TransitionTable {
    ...
    const blueprint = Array.apply(null, Array(BYTE_VALUES)).map((_unused: any, i: number) => i);
...
export class EscapeSequenceParser extends Disposable implements IEscapeSequenceParser {
    ...
    constructor(protected readonly _transitions: TransitionTable = VT500_TRANSITION_TABLE) {
        ...
        this._printHandlerFb = (_data, _start, _end): void => {};
        this._executeHandlerFb = (_code: number): void => {};
        this._csiHandlerFb = (_ident: number, _params: IParams): void => {};
        this._escHandlerFb = (_ident: number): void => {};
    ...
    public parse(data: Uint32Array, length: number): void {
        ...
        for (let i = 0; i < length; ++i) {
            ...
            transition =
                table[(currentState << TableAccess.INDEX_STATE_SHIFT) | (code < 0xa0 ? code : NON_ASCII_PRINTABLE)];
