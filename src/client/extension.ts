...
import { GLOBAL_MEMENTO, IConfigurationService, IDismissableSurveyBanner,
    IDisposableRegistry, IExtensionContext, ILogger, IMemento, IOutputChannel,
...
export async function activate(context: ExtensionContext) {
    ...
    serviceContainer.get<IDismissableSurveyBanner>(IDismissableSurveyBanner).initialize();
