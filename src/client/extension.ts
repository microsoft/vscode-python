...
async function initializeServices(
    ...
    const outputChannel = serviceManager.get<OutputChannel>(
        IOutputChannel,
        STANDARD_OUTPUT_CHANNEL
    );
    disposables.push(
    ...
    serviceContainer
        ...
        .register();
    serviceContainer
        .get<ITestCodeNavigatorCommandHandler>(ITestCodeNavigatorCommandHandler)
        .register();
    serviceContainer
        .get<ITestExplorerCommandHandler>(ITestExplorerCommandHandler)
        .register();
    serviceContainer
        .get<ILanguageServerExtension>(ILanguageServerExtension)
        .register();
...
async function getActivationTelemetryProps(
    ...
    const usingGlobalInterpreter = isUsingGlobalInterpreterInWorkspace(
        settings.pythonPath,
        serviceContainer
    );
