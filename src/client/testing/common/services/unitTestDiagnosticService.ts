...
export class UnitTestDiagnosticService implements ITestDiagnosticService {
    ...
    constructor() {
        ...
        this.MessageSeverities.set(
            PythonTestMessageSeverity.Error,
            DiagnosticSeverity.Error
        );
        this.MessageSeverities.set(
            PythonTestMessageSeverity.Failure,
            DiagnosticSeverity.Error
        );
        this.MessageSeverities.set(
        ...
        this.MessagePrefixes.set(
            ...
            localize.Testing.testErrorDiagnosticMessage()
        );
        this.MessagePrefixes.set(
            DiagnosticMessageType.Fail,
            localize.Testing.testFailDiagnosticMessage()
        );
        this.MessagePrefixes.set(
            DiagnosticMessageType.Skipped,
    ...
    public getMessagePrefix(status: TestStatus): string | undefined {
        ...
        return msgType !== undefined
            ? this.MessagePrefixes.get(msgType!)
            : undefined;
    }
    public getSeverity(
        unitTestSeverity: PythonTestMessageSeverity
    ): DiagnosticSeverity | undefined {
