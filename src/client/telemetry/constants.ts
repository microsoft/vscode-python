...
export enum EventName {
    ...
    PYTHON_PYRX_ENABLED = 'PYTHON_LANGUAGE_SERVER.ENABLED',
    PYTHON_PYRX_STARTUP = 'PYTHON_PYRX.STARTUP',
    PYTHON_PYRX_READY = 'PYTHON_PYRX.READY',
    PYTHON_PYRX_TELEMETRY = 'PYTHON_PYRX.EVENT',
