        ...
        return promise
            .then(async () => {
                ...
                if (!refreshp) {
                    ...
                    traceInfo('Refresh promise is NOT undefined');
                    refreshp
                        .then(() => traceInfo('All refresh promises from all queries resolved'))
                        .catch((ex) => {
                            traceError('Failure while resolving all refresh promises from all queries', ex);
                        });
                }
