...
export class VariableExplorerCellFormatter extends React.Component<
    IVariableExplorerCellFormatterProps
> {
    ...
    public render() {
        ...
        if (this.props.value !== null && this.props.value !== undefined) {
            return (
                <div className={className} title={this.props.value.toString()}>
                    {this.props.value}
                </div>
            );
        }
