...
import {
    CellStyle,
    VariableExplorerCellFormatter
} from "./variableExplorerCellFormatter";
...
export class VariableExplorer extends React.Component<
    IVariableExplorerProps,
    IVariableExplorerState
> {
        ...
        const columns = [
            {
                key: "name",
                name: getLocString(
                    "DataScience.variableExplorerNameColumn",
                    "Name"
                ),
                type: "string",
                width: 120,
            ...
            },
            {
                key: "type",
                name: getLocString(
                    "DataScience.variableExplorerTypeColumn",
                    "Type"
                ),
                type: "string",
                width: 120
            },
            {
                key: "size",
                name: getLocString(
                    "DataScience.variableExplorerSizeColumn",
                    "Count"
                ),
                type: "string",
                width: 120,
            ...
            },
            {
                key: "value",
                name: getLocString(
                    "DataScience.variableExplorerValueColumn",
                    "Value"
                ),
                type: "string",
                width: 300
                ...
                >
                    <CollapseButton
                        ...
                        tooltip={getLocString(
                            ...
                            "Collapse variable explorer"
                        )}
                        label={getLocString(
                            "DataScience.collapseVariableExplorerLabel",
                            "Variables"
                        )}
                    />
    ...
    public componentDidMount = () => {
        ...
        if (this.divRef.current) {
            const newFontSize = parseInt(
                getComputedStyle(this.divRef.current).getPropertyValue(
                    "--code-font-size"
                ),
                10
            );
    ...
    public newVariablesData(newVariables: IJupyterVariable[]) {
        const newGridRows = newVariables.map(newVar => {
            return {
                ...
                size: "",
                value: getLocString(
                    "DataScience.variableLoadingValue",
                    "Loading..."
                )
            };
        });
    ...
    private getComparisonValue(
        ...
        return sortColumn === "size"
            ? this.sizeColumnComparisonValue(gridRow)
            : gridRow[sortColumn];
    }
