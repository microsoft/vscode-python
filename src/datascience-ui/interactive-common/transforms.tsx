...
const mimeTypeToImport: TransformData[] = [
    new TransformData('application/vnd.vega.v2+json', async () => {
        const module = await import('@nteract/transform-vega');
        return module.Vega2;
    }),
    ...
    new TransformData('image/svg', async () => {
        const module = await import('@nteract/transforms');
    ...
    new TransformData('application/vdom.v1+json', async () => {
        const module = await import('@nteract/transform-vdom');
        return module.VDOM;
    }),
