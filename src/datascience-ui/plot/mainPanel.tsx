    ...
    public render = () => {
        ...
        return (
            <div className="main-panel" role="group" ref={this.container}>
                <StyleInjector expectingDark={this.props.baseTheme !== 'vscode-light'} darkChanged={this.darkChanged} postOffice={this.postOffice} />
    ...
    private renderThumbnails(_baseTheme: string) {
        return (
            <SvgList
                ...
                themeMatplotlibBackground={getSettings().themeMatplotlibPlots ? true : false}
            />
        );
    }
