...
export class CellFormatter extends React.Component<ICellFormatterProps> {
    private loadingMessage = getLocString(
    ...
    public render() {
        ...
        if (
            this.props.row === DataViewerRowStates.Skipped ||
            this.props.row === DataViewerRowStates.Fetching
        ) {
        ...
        return (
            <div className="cell-formatter" title={val}>
                <span>{val}</span>
            </div>
        );
    }
    ...
    private renderBool(value: boolean) {
        return (
            <div className="cell-formatter" title={value.toString()}>
    ...
    private renderNumber(value: number) {
        ...
        return (
            <div className="number-formatter cell-formatter" title={val}>
                <span>{val}</span>
            </div>
        );
    }
