...
Feature: Language Server
    ...
    Scenario Outline: When <reload_or_start_vs_for_first_time> with Jedi <jedi_enable>d then intellisense works
        ...
        Examples:
            ...
            | enable      | I open VS Code for the first time | 5                | Jedi Python language engine      | Jedi Python language engine      | 5         | Python: Show Output                 |
            | enable      | I reload VS Code                  | 5                | Jedi Python language engine      | Jedi Python language engine      | 5         | Python: Show Output                 |
            | disable     | I open VS Code for the first time | 120              | Microsoft Python language server | Microsoft Python language server | 5         | Python: Show Language Server Output |
            | disable     | I reload VS Code                  | 120              | Microsoft Python language server | Microsoft Python language server | 5         | Python: Show Language Server Output |
